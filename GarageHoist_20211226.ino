...
4.  Normal operation of the tennis balls is as prompted ont he buttons:  Tap for Up or Tap for Down
...
const int M1Con1 = 5; //PWM Pin 5 for Motor 1, Enable 1 on L293D Chip
const int M1Con2 = 3; //Pin 3 for Motor 1
const int M1Con3 = 4; //Pin 4 for Motor 1
const int M2Con1 = 9; //PWM Pin 9 for Motor 2, Enable 2 on L239D Chip
const int M2Con2= 6; //Pin 6 for Motor 2
const int M2Con3 = 7; //Pin 7 for Motor 2
